...
setwd("/data/user/shared_projects/ulk1/tcga/rnaseq/COAD/1-download_preprocessing/")
...
# Get harmonized queries using GDCquery from a specific project, e.g "TCGA-COAD",
...
dataPrep1 <- GDCprepare(query = query, 
                        save = TRUE,
                        save.filename = "TCGA_COAD_HTSeq_Counts_08072019.rda")
dim(dataPrep1)
...
#dataPrep1 <- get(load('TCGA_COAD_HTSeq_Counts_08072019.rda'))
...
dataPrep2 <- TCGAanalyze_Preprocessing(object = dataPrep1, cor.cut = 0.6, filename = "COAD_dataprep_08072019.png")
dim(dataPrep2)
#[1] 56602   519
...
save(dataPrep2, file = "COAD_PreprocessedData_all_Prep_08072019.rda")
...
save(dataNorm, file= "COAD_PreprocessedData_all_Norm_08072019.rda")
...
save(dataFilt, file = "COAD_PreprocessedData_all_Filt_08072019.rda")

...
setwd("/data/user/shared_projects/ulk1/tcga/rnaseq/GBM/1-download_preprocessing/")
...
# Get harmonized queries using GDCquery from a specific project, e.g "TCGA-GBM",
...
dataPrep1 <- GDCprepare(query = query,
                               save = TRUE,
                               save.filename = "TCGA_GBM_HTSeq_Counts_07062019.rda")
dim(dataPrep1)
#[1] 56602   161
...
#prep_harmo <- get(load('TCGA_GBM_HTSeq_Counts_03062019.rda'))
...
dataPrep2 <- TCGAanalyze_Preprocessing(object = dataPrep1, cor.cut = 0.6, filename = "GBM_dataprep_03062019.png")
dim(dataPrep2)
#56602   161
...
save(dataPrep2, file = "GBM_PreprocessedData_all_Prep_07062019.rda")
...
save(dataNorm, file= "GBM_PreprocessedData_all_Norm_07062019.rda")
...
save(dataFilt, file = "GBM_PreprocessedData_all_Filt_07062019.rda")
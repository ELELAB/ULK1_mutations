...
setwd("/data/user/shared_projects/ulk1/tcga/rnaseq/DLBC/2-DEA_rec//")
...
#12995
write.table(data.DEGs, file = "DEA_rec_DLBC.txt", quote = FALSE)
...
pdf(file= "boxplot.DLBC.pdf")
boxplot(dataFilt_normal_ULK1, dataFilt_cancer_ULK1)
dev.off()

pdf(file= "boxplot.DLBC.ULK2.pdf")

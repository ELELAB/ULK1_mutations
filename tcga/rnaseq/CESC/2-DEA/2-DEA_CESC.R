...
DataFilt <- get(load('../1-download_preprocessing/CESC_PreprocessedData_all_Filt_08072019.rda'))
...
write.table(dataDEGs.TSS, file = "DEA_TSS_CESC.txt", quote = FALSE)
...
dataDEGs.Plate <- TCGAanalyze_DEA(mat1 = dataFilt[,dataSmNT_p],
                                ...
                                voom = TRUE)
#6267
write.table(dataDEGs.Plate, file = "DEA_Plate_CESC.txt", quote = FALSE)
...
write.table(dataDEGs.Center, file = "DEA_Center_CESC.txt", quote = FALSE)
#Not available

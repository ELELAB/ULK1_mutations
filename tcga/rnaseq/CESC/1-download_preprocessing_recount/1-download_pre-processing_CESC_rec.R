...
setwd("/data/user/shared_projects/ulk1/tcga/rnaseq/CESC/1-download_preprocessing_recount/")
...
## Get GDC queries using the function abCESCe
## project = "TCGA-CESC"
...
###to check that there are few NT samples
...
##search outliers - only remCESCing samples not genes

#dataPrep2a <- TCGAanalyze_Preprocessing(object = dataPrep2, cor.cut = 0.6, filename = "CESC_dataprep_07062019.png")
#dim(dataPrep2a)
#56734   1201

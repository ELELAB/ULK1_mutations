...
setwd("/data/user/shared_projects/ulk1/tcga/rnaseq/CESC/1-download_preprocessing/")
...
dataPrep1 <- GDCprepare(query = query, 
                        save = TRUE,
                        save.filename = "TCGA_CESC_HTSeq_Counts_08072019.rda")
dim(dataPrep1)
...
#dataPrep1 <- get(load('TCGA_CESC_HTSeq_Counts_08072019.rda'))
...
dataPrep2 <- TCGAanalyze_Preprocessing(object = dataPrep1, cor.cut = 0.6, filename = "CESC_dataprep_08072019.png")
dim(dataPrep2)
#[1] 56602   307
...
save(dataPrep2, file = "CESC_PreprocessedData_all_Prep_08072019.rda")
...
save(dataNorm, file= "CESC_PreprocessedData_all_Norm_08072019.rda")
...
save(dataFilt, file = "CESC_PreprocessedData_all_Filt_08072019.rda")
